...
gu_list = [
    Stock('sz.000099', '中信海直', '2026-01-01', end_date=current_date),
    Stock('sz.002085', '万丰奥威', '2026-01-01', end_date=current_date),
    Stock('sh.600487', '亨通光电', '2026-01-01', end_date=current_date),
    Stock('sz.002155', '湖南黄金', '2026-01-01', end_date=current_date),
    Stock('sh.600875', '东方电气', '2026-01-01', end_date=current_date),
    Stock('sz.000988', '华工科技', '2026-01-01', end_date=current_date),
    Stock('sz.000603', '盛达资源', '2026-01-01', end_date=current_date),
    Stock('sz.000636', '风华高科', '2026-01-01', end_date=current_date),
    Stock('sh.600879', '航天电子', '2026-01-01', end_date=current_date),
